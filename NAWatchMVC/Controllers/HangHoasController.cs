...
namespace NAWatchMVC.Controllers
{
    public class HangHoasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaHh,TenHh,TenAlias,MaLoai,MaNcc,DonGia,GiamGia,Hinh,NgaySx,SoLanXem,MoTa,SoLuongBan,SoLuong,GioiTinh,DuongKinhMat,ChatLieuDay,DoRongDay,ChatLieuKhungVien,ChatLieuKinh,TenBoMay,ChongNuoc,TienIch,NguonNangLuong,LoaiMay,BoSuuTap,XuatXu,DiemDanhGia")] HangHoa hangHoa)
        {
